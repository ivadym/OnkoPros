 ...
 */
exports.extraerTituloEntrevista = function (idEntrevista) {
    return new Promise(function(resolve, reject) {
        var connection = new Connection(config.auth);
        var query = `SELECT Titulo
                    FROM GEOP_ENTREVISTA
                    WHERE IdEntrevista=@idEntrevista AND Estado=1;`;
        var result = [];
